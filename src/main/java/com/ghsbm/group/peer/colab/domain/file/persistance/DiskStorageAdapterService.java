...
import com.ghsbm.group.peer.colab.application.config.StorageProperties;
...
@Service
public class DiskStorageAdapterService implements StorageService {
  private final Path rootLocation;

  @Autowired
  public DiskStorageAdapterService(StorageProperties properties) {
