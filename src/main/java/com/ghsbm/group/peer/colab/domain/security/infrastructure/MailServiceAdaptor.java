package com.ghsbm.group.peer.colab.domain.security.infrastructure;
 ...
 */
@Service
public class MailServiceAdaptor implements MailService {

    private final Logger log = LoggerFactory.getLogger(MailServiceAdaptor.class);
    ...
    private void sendEmailSync(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(peerProperties.getMail().getFrom());
    ...
    private void sendEmailFromTemplateSync(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, peerProperties.getMail().getBaseUrl());
