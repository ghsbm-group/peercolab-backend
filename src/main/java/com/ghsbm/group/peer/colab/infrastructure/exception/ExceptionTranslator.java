...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    ...
    if (ex
        instanceof
        com.ghsbm.group.peer.colab.domain.security.core.ports.incoming.exception
    ...
    if (ex
        ...
        com.ghsbm.group.peer.colab.domain.classes.core.ports.incoming.exception
            .ClassConfigurationAlreadyExistsException)
      return (ProblemDetailWithCause) new ClassConfigurationAlreadyExistsException().getBody();
    if (ex
        instanceof
        com.ghsbm.group.peer.colab.domain.classes.core.ports.incoming.exception
