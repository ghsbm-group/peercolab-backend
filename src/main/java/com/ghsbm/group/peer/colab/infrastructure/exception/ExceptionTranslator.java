...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof com.ghsbm.group.peer.colab.domain.security.core.ports.incoming.exception.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.ghsbm.group.peer.colab.domain.security.core.ports.incoming.exception.InvalidPasswordException
    ...
    private String getCustomizedErrorDetails(Throwable err) {
        ...
        if (activeProfiles.contains(PeerConstants.SPRING_PROFILE_PRODUCTION)) {
